...
if (isset($_POST['add_product'])) {
    ...
    $query = "INSERT INTO products(title_products,image_products,description_products,infor_products,price_products) VALUES ('$product_title','$product_image','$product_desc','$product_info',$product_price)";
