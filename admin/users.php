                    ...
                    <tr>
                      ...
                      <?php 
                            ...
                            while ($row = mysqli_fetch_array($load_users_query)) {
                                ...
                                $user_fname = $row['fname_users'];
                                $user_lname = $row['lname_users'];
                            ...
                            if (isset($_GET['delete'])) {
                                ...
                                $delete_query = "DELETE FROM users WHERE id_users = $deleted_user_id";
                                $deleted_user_query = mysqli_query($conn,$delete_query);
